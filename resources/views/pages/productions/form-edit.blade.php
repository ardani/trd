...
<hr class="hr-form"/>
<div class="col-md-12">
    <table id="listItemOrder" class="display table table-bordered" cellspacing="0" width="100%" style="margin-bottom: 10px">
        <thead>
        <tr>
            <th width="10%">Code</th>
            <th>Product Name</th>
        ...
        @foreach($model->sale_order->transactions as $transaction)
            <tr>
                ...
                <td>
                    <button type="button" data-id="{{$transaction->product_id}}" class="btn btn-sm btn-success setActive">choose</button>
                </td>
            </tr>
        @endforeach
        </tbody>
...
<fieldset class="form-group col-md-2">
    ...
    <div class="input-group">
        ...
        <div class="input-group-btn">
            <button type="button" id="save-btn" data-url="{{url('productions/actions/add')}}" class="btn btn-info"><span
