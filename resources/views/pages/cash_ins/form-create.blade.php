...
<fieldset class="form-group col-md-3">
    <label class="form-control-label">No Cash In <span class="text-danger">*</span></label>
    <input id="no" type="text" name="no" class="form-control" readonly
           value="{{ $auto_number_cash_in }}">
        {{ csrf_field() }}
</fieldset>
...
<fieldset class="form-group col-md-2">
        ...
        <input type="number" id="debit" required placeholder="debit" class="form-control" value="">
</fieldset>
...
<fieldset class="form-group col-md-1">
    <button style="margin-top: 25px" type="button"
            id="save-btn"
            data-url="{{url('cash_ins/actions/addTemp')}}"
            class="btn btn-success">save</button>
</fieldset>
<div class="clearfix"></div>
<div class="col-md-12">
<table id="table-cashins-details" class="display table table-bordered" cellspacing="0" width="100%">
    <thead>
    <tr>
        <th width="10%">No</th>
        ...
        @if($transactions)
            @foreach($transactions as $transaction)
                <tr>
                    ...
                    <td>
                        <a class="act-delete" data-url="{{url('cash_ins/actions/deleteTemp')}}"
