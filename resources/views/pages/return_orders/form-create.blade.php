...
<fieldset class="form-group col-md-3">
    ...
    <input id="no-ro" type="text" name="no" readonly class="form-control" value="{{auto_number_return_orders()}}">
    {{ csrf_field() }}
</fieldset>
<fieldset class="form-group col-md-3">
    <label class="form-control-label">No Order <span class="text-danger">*</span></label>
    <select name="no_order" class="form-control select-no-order" data-url="{{url('orders/ajaxs/detail')}}"></select>
</fieldset>
<fieldset class="form-group col-md-3">
    <label class="form-control-label">Supplier <span class="text-danger">*</span></label>
    <input id="supplier" type="text" readonly class="form-control"/>
</fieldset>
            ...
            @foreach($transactions as $transaction)
                <tr>
                    ...
                    <td><input data-id="{{$transaction['product_id']}}"
                               type="number" data-url="{{url('return_orders/actions/addTemp')}}"
                               value="1" class="form-control col-md-1 qty-input"/></td>
                    <td>
                        <a class="act-add-return" data-url="{{url('return_orders/actions/addTemp')}}"
