...
@section('content')
    <div class="page-content">
        <div class="container-fluid">
            ...
            <section class="card">
                <div class="card-block">
                    <table id="table-request-product" data-url="{!! url(request()->path()) !!}" class="display table table-bordered" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th>No</th>
                            <th>Note</th>
...
@section('scripts')
    <script type="text/javascript">
        $('.btn-filter').click(function (e) {
            $('#table-request-product').DataTable().ajax.reload();
        });
    </script>
@endsection